<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentRegistrationUI.aspx.cs" Inherits="UniversityStudentsDataCRUDWebApp.StudentRegistrationUI" %>
    ...
    <fieldset>
        ...
        <div>
            <table>
                ...
                <tr><td></td>
                    <td>
                    <asp:Button ID="saveButton" runat="server" Text="Save" OnClick="saveButton_Click" Width="129px" /></td>
                </tr>
